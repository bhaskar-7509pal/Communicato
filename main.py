...
def text_mode(cam):
	...
	while True:
		...
		if len(contours) > 0:
			...
			word = ""
		blackboard = np.zeros((480, 640, 3), dtype=np.uint8)
		cv2.putText(blackboard, name , (180, 50), cv2.FONT_HERSHEY_TRIPLEX, 1.5, (255, 167,0))
...
tanvir_image = face_recognition.load_image_file("images\Tanvir\Tanvir.jpg")
tanvir_face_encoding = face_recognition.face_encodings(tanvir_image)[0]

# Load a second sample picture and learn how to recognize it.
bhaskar_image = face_recognition.load_image_file("images\Bhaskar\Bhaskar.jpeg")
bhaskar_face_encoding = face_recognition.face_encodings(bhaskar_image)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
    tanvir_face_encoding,
